...
insert into 부서 values('A5', '마케팅부'); -- 컬럼 순서대로 작성해야 함
...
('E21', '박바나나', '수습사원', '여', curdate()),('E22', '정오렌지', '수습사원', '여', curdate());

-- update
-- update 테이블명 set 컬럼1 = 값1, 컬럼2 = 값2, ... where 조건;
update 사원 set 이름 = '김레몬' where 사원번호 = 'E20'; -- where조건이 없으면 모든 열이 변경됨
...
delete from 사원 order by 입사일 desc limit 3; -- 가장 최근 입사자로 정렬하고 위에서 3개 row를 삭제

-- insert on duplicate key upadte
